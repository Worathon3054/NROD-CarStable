        ...
        if ($row = mysqli_fetch_assoc($resultl)){ 
            ...
            if (!empty($row['username'])){
                ...
                if (!mysqli_stmt_prepare($result, $sql)) {
                    ...
                    if (!$row = mysqli_fetch_assoc($resultl)){
                        if ($t <= $TimeArrive) {
                            $UserStat = "Phitsanulok"; //Arrived on time
                        }
                        else{
                            $UserStat = "Phitsanulok"; //Arrived late
                        }
                    ...
                    //Logout
                        ...
                        if ($t >= $Timeleft && $row['TimeIn'] <= $TimeArrive) {
                            $UserStat = "Phitsanulok"; //Arrived and Left on time
                        }
                        elseif ($t < $Timeleft && $row['TimeIn'] > $TimeArrive){   
                            $UserStat = "Phitsanulok";//Arrived late and Left early
                        }
                        elseif ($t < $Timeleft && $row['TimeIn'] <= $TimeArrive) {
                            $UserStat = "Phitsanulok";//Arrived on time and Left early
                        }
                        elseif ($t >= $Timeleft && $row['TimeIn'] > $TimeArrive) {
                            $UserStat = "Phitsanulok";//Arrived late and Left on time
                        }
